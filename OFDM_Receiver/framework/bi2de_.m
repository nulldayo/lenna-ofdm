...
%   input is Left-MSB; the last element in B represents the least
%   significant bit.
%
...
%   'left-msb' MSBFLAG does not change the function's default behavior.
%   Giving a 'right-msb' MSBFLAG flips the input orientation such that the
%   MSB is on the right.
%
%   Examples:
%       B = [0 0 1 1; 1 0 1 0];
