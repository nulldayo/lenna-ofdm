...
%
% last modifications: 
% 2013/09/18 - M.Sc. Stephan Schedler (changed default to 'left-msb')
%
%
%
%
...
%   Left-MSB; the last element in B represents the lowest bit.
%
...
%   'left-msb'.  Giving a 'left-msb' MSBFLAG does not change the
%   function's default behavior.  Giving a 'right-msb' MSBFLAG flips the
%   output orientation to display the MSB to the right.
%
%   Examples:
%       E = [12; 5];
%
...
if(p==2)
    [unused,e]=log2(max(d)); % How many digits do we need to represent the numbers?
